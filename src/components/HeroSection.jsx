...
export default function HeroSection() {
  return (
    <section className="w-full h-[35rem] md:w-[90vw] lg:w-[70vw] lg:max-w-[80rem] my-20 relative rounded-none md:rounded-2xl overflow-hidden mx-auto">
      <img
        src="assets\images\hero-section-image.jpg"
