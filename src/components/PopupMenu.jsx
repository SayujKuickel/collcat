...
export default function PopupMenu({ text, itemList, mobileMode = false }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`  flex flex-col gap-3 px-4 py-2 rounded-md z-[10000] text-white   ${
          isHovered
            ? "block opacity-100 translate-y-0"
            : "hidden opacity-0 -translate-y-10"
        } md:w-[18rem] md:absolute md:top-full md:left-1/2 md:-translate-x-1/2 md:bg-[#fafafa] md:text-black md:shadow-xl transition-all duration-500 ease-in-out`}
      >
